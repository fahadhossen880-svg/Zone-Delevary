...
if IS_PRODUCTION:
    ...
    env_hosts = os.getenv('ALLOWED_HOSTS', 'zone-delevary.onrender.com,zonedelevary.store,www.zonedelevary.store')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'shop.context_processors.firebase_config',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@zonedelivery.com')
